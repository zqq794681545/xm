...
<html>
	<head>
		...
		<title></title>
		<link rel="stylesheet" type="text/css" href="../xm/css/base.css">
		<link rel="stylesheet" type="text/css" href="../xm/javascript/easyui/themes/bootstrap/easyui.css">
		<link rel="stylesheet" type="text/css" href="../xm/javascript/easyui/themes/bootstrap/easyui-extend.css">
		<link rel="stylesheet" type="text/css" href="../xm/javascript/easyui/themes/icon.css">
		<link rel="stylesheet" type="text/css" href="../xm/css/button.css">
		<link rel="stylesheet" type="text/css" href="../xm/javascript/easyui/themes/color.css">
		<script type="text/javascript" src="../xm/js/jquery-1.8.3.js" charset="UTF-8"></script>
		<script type="text/javascript" src="../xm/javascript/easyui/jquery.min.js"></script>
		<script type="text/javascript" src="../xm/js/easyui/jquery.easyui.min.js" charset="UTF-8"></script>
		<script type="text/javascript" src="../xm/javascript/easyui/jquery.easyui.min.js"></script>
		<script type="text/javascript" src="../xm/javascript/easyui/easyui.tree.extend.js"></script>
		<script type="text/javascript" src="../xm/javascript/easyui/easyui.treegrid.extend.js"></script>
		<script type="text/javascript" src="../xm/javascript/easyui/tabs.ext.js"></script>
		<script type="text/javascript" src="../xm/javascript/easyui/locale/easyui-lang-zh_CN.js"></script>
		
		<script type="text/javascript" src="../xm/javascript/jquery.cookie.js"></script>
		<script type="text/javascript" src="../xm/javascript/easyuiutil.js"></script>
		<script type="text/javascript" src="../xm/javascript/basecombobox.js"></script>
		<script type="text/javascript" src="../xm/javascript/phjg.common.js"></script>
		<script type="text/javascript" src="../xm/javascript/store.js"></script>
		<script type="text/javascript" src="../xm/javascript/basetype.js"></script>
		
		<script type="text/javascript" charset="utf-8" src="../xm/javascript/ueditor/ueditor.config.js"> </script>
		<script type="text/javascript" charset="utf-8" src="../xm/javascript/ueditor/ueditor.all.js"></script>
	    <script type="text/javascript" charset="utf-8" src="../xm/javascript/ueditor/lang/zh-cn/zh-cn.js"></script>
		
		<script type="text/javascript" src="../xm/content/dkxx.js" charset="UTF-8"></script>
		<style>
			body,html {
				margin: 0;
			}
